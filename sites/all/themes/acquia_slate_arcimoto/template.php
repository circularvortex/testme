...
function acquia_slate_arcimoto_preprocess(&$vars) {

}

function acquia_slate_arcimoto_preprocess_page(&$vars) {
...
function acquia_slate_arcimoto_preprocess_node(&$vars) {
...
function acquia_slate_arcimoto_user_login($form) {
  $output = '';
